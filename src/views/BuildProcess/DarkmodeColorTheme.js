...
function DarkmodeColorTheme(){
	...
	return (
		<Layout.Cell modifiers={["padding", "child-margin"]}>
			...
			{translate("title-01-array-01", "build-process-darkmode-theme")?.map(item =>
				<p key={item} className="BuildProcess__text">{item}</p>
			)}
			...
			{translate("title-01-array-02", "build-process-darkmode-theme")?.map(item =>
				<p key={item} className="BuildProcess__text">{item}</p>
			)}
			<Code title="React - JavaScript">
				<Code.Function.Call name="useEffect" parameters={[
					<Code.Function.Block arrow>
						<Code.CommaSeparated separator="." items={[
					...
					<Code.Operator>[<Code.Property>darkmode</Code.Property>]</Code.Operator>
				]} /><Code.Operator>;</Code.Operator>
			</Code>
			...
			{translate("title-02-array-01", "build-process-darkmode-theme")?.map(item =>
				<p key={item} className="BuildProcess__text">{item}</p>
			)}
			<Code title="CSS - variables">
				...
				<Code.Css.Property property="--theme">
					<Code.Css.Hsl h={
						...
						<Code.Css.Var values={[<Code.Property>--saturation</Code.Property>]} />
					} l="40%" />
				</Code.Css.Property>
			...
			<Code title="React - JavaScript">
				<Code.Function.Call name="useEffect" parameters={[
					<Code.Function.Block arrow>
						<Code.Line>
							<Code.CommaSeparated separator="." items={[
								...
								<Code.Function.Call name="setProperty" parameters={[
					...
					<Code.Operator>[<Code.Property>theme</Code.Property>]</Code.Operator>
				]} /><Code.Operator>;</Code.Operator>
			</Code>
		</Layout.Cell>
	);
