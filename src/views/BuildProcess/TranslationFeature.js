...
function TranslationFeature(){
	...
	return (
		<Layout.Cell modifiers={["padding", "child-margin"]}>
			...
			<Code title="React - JavaScript" caption={<Infotip
						...
						(
							<Code.Indent>
								<Code.Component tag="button">
									<Code.Component tag="Translate" props={[
										{
											property: "id",
				...
				<Code.Function.Block name="MyComponent">
					...
					<Code.Return>
						(
							<Code.Indent>
								<Code.Component tag="button">
									<Code.Component tag="Translate" noSpace props={[
										{
											property: "id",
										...
										},
										{
											...
											value: <Code.Block>
												<Code.Component tag="span" props={[
													{
														property: "style",
														value: <Code.Block>
															<Code.KeyValue property="backgroundColor"><Code.String>orange</Code.String></Code.KeyValue>
															<Code.KeyValue property="padding" separator=""><Code.String>0 0.25rem</Code.String></Code.KeyValue>
														</Code.Block>
													}
												]}>Sune</Code.Component>
											</Code.Block>
